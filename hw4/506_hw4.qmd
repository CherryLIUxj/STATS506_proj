...
![](images/截屏2023-10-22%20下午8.29.53.png)

California has the highest percentage of records;

Michigan's percentage of records is 3.1724%.
...
![](images/截屏2023-10-22%20下午8.31.12.png)
...
![](images/截屏2023-10-22%20下午8.31.34.png)
...
![](images/截屏2023-10-22%20下午8.31.58.png)

![](images/截屏2023-10-22%20下午8.32.22.png)

## e. Use that model to generate predicted values and create a scatter plot of predicted total electricity cost vs actual total electricity cost (**not** on the log scale).
...
![](images/截屏2023-10-22%20下午8.32.46.png)
...
![](images/截屏2023-10-22%20下午2.52.16.png)

![](images/截屏2023-10-23 下午4.46.50.png)

![![](images/截屏2023-10-22%20下午3.12.34.png)](images/截屏2023-10-22%20下午3.03.37.png)
...
B7_b (In your country - How would you rate economic conditions today)
...
proc sql;
	...
	select CaseID, weight_pop, B3, ND2, B7_b, GH1, ppeducat, race_5cat
...
![](images/截屏2023-10-23 下午4.47.35.png)
...
![](images/截屏2023-10-23 下午4.47.51.png)
...
![![](images/截屏2023-10-23 下午4.48.47.png)](images/截屏2023-10-23 下午4.48.32.png)
...
```{r}
logit_mod <- svyglm(b3 ~ nd2 + b7_b + factor(gh1) + ppeducat + factor(race_5cat), data = public2022, family = binomial(link="logit"), design=design)
summary(logit_mod)
```
